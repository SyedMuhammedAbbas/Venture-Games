    ...
    <>
      <div className="bg-[#FFB636] snap-start text-[20px] text-black pt-[10%] px-20 pb-20 tablet:pt-[20%] tablet:px-5">
        <div>
          ...
          <p>&nbsp;</p>
          <p>
            <strong>*FOR SALE OF USED CONSOLES &amp; ACCESSORIES*</strong>
          </p>
          <p>
            <strong>&nbsp;</strong>
          </p>
          <p>
            <strong>
              *Checking &amp; payment policy for customers outside Karachi
            </strong>
          </p>
          <p>
            If you are located outside Karachi &amp; wish to sell your console
            or gaming accessories then the following procedure will be followed.
            <br /> <br /> - Once we receive your parcel our Quality Team will
            thoroughly inspect the console
          </p>
          <p>
            - If the console/accessory matches our criteria then we will
            transfer the payment the next day or else we’ll send the shipment
            back to your postal address.
            <br /> <br />{" "}
            <strong>
              *Checking &amp; payment policy for customers outside Karachi
              <br />{" "}
            </strong>
            If you are located in Karachi &amp; wish to sell your console or
            gaming accessories then the following procedure will be followed.
            <br /> <br /> - You can visit our shop at the mentioned address
            physical or ship us the parcel.
          </p>
          <p>
            - Once we receive your parcel our Quality Team will thoroughly
            inspect the console/accessory
          </p>
          <p>
            - If the console/accessory matches our criteria then we will
            transfer the payment the same day or else we’ll send the shipment
            back to your postal address.
          </p>
          <p>
            <strong>&nbsp;</strong>
          ...
          <p>
            ...
            followed.
            <br /> <br /> - To book your order you can transfer the amount via
            bank transfer, easy paisa or jazz cash
          </p>
          <p>
            - Send the screenshot of the payment to our official numbers and
            once the amount is&nbsp; credited at our end we will dispatch the
            parcel after the confirmation.
          </p>
          <p>
            <br />{" "}
            <strong>
              *Checking &amp; payment policy for customers in Karachi
              <br />{" "}
            </strong>
            If you are located in Karachi &amp; wish to purchase a new console
            or gaming accessory then the following procedure will be followed.
            <br /> - You can visit our physical shop on the mentioned address
            and pay there and then.
          </p>
          <p>
            - Cash On Delivery Service is available in Karachi only along with
            the prepayment procedure. (jazzcash,easypaisa or bank transfer).
          </p>
          <p>&nbsp;</p>
          <p>
            <strong>
          ...
          <p>
            This website is operated by Venture Games. Throughout the site, the
            terms “we”, “us” and “our” refer to Venture Games offers this
          ...
          <p>&nbsp;</p>
          <p>
            Our store is hosted on Wordpress. They provide us with the online
          ...
          <p>
            In no case shall BabyTime.pk, our directors, officers, employees,
          ...
          <p>
            You agree to indemnify, defend and hold harmless BabyTime.pk and our
          ...
          <p>
            ...
            contact@venturegames.com
          </p>
          <p>
            Our contact information is posted below
            <br /> <br /> Email:contact@venturegames.com
          </p>
          <p>
            Phone No. +92 335 8243343
            <br /> <br />{" "}
            <strong>
              <span style={{ textDecoration: "underline" }}>
                Privacy policy
          ...
          <p>
            This Privacy Policy describes how venturegames.com (the “Site” or
          ...
          <p>
            ...
            a complaint, please contact us by e-mail at contact@venturegames.com
            or by mail using the details provided below:
          </p>
          <p>&nbsp;Karachi 79001, Pakistan</p>
          <p>
            <strong>
              <span style={{ textDecoration: "underline" }}>
          ...
          <p>
            <strong>
              <span style={{ textDecoration: "underline" }}>Minors</span>
            </strong>
          </p>
          <p>
            The Site is not intended for individuals under the age of{" "}
            <em>[INSERT AGE]</em>. We do not intentionally collect Personal
          ...
          <ul>
            <li>We use Wordpress to power our online store.</li>
            <li>
          ...
          <p>
            <strong>
              <span style={{ textDecoration: "underline" }}>Lawful basis</span>
            </strong>
          </p>
          <p>
          ...
          <p>
            <strong>
              <span style={{ textDecoration: "underline" }}>Retention</span>
            </strong>
          </p>
          <p>
          ...
          <p>
            We <em>[DO/DO NOT]</em> engage in fully automated decision-making
            that has a legal or otherwise significant effect using customer
            data.
          </p>
          <p>
            Our processor WordPress uses limited automated decision-making to
