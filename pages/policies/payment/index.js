...
export default function PaymentPolicies() {
  ...
  return (
    <>
      ...
      <div className="bg-[#FFB636] text-[25px] mobile:text-[20px] snap-start text-black pt-[10%] px-20 pb-20 min-h-[140vh] mmobile:min-h-[125vh] max-h-[100%] tablet:pt-[20%] tablet:px-10">
