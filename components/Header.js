    ...
    <>
      <div className="flex p-10 mx-auto justify-center bg-gradient-to-t from-black to-[#2c2c2c] fixed w-[100%] z-[999]">
        <ul className="flex gap-[8vw] uppercase text-white text-xl transition-all mb-[-10px] 4xl:text-lg xl:gap-[7vw] lg:mb-[-20px] ">
          ...
          <div className="tablet:space-y-[6px] hidden tablet:grid tablet:absolute tablet:left-10 tablet:mt-[-15px]">
          ...
          <Link href="/">
            <a>
              <img
                className="w-28 mt-[-25px] 2xl:w-24 lg:w-[70px] lg:h-14 tablet:w-[55px] tablet:h-[50px] tablet:mt-[-28px] "
                src={logo.src}
              />
            </a>
          </Link>
