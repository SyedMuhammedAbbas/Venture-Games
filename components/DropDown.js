...
export default function DropDown() {
  return (
    <>
      <div className="absolute bottom-0 mb-[-5px] right-[10rem] text-[#000] opacity-70 z-10 text-[25px] 2xl:mb-[-12px] 2xl:right-32">
        <GoTriangleUp />
      </div>
      ...
      {/* <div
        ...
        style="transform:translate(137.181px,-13px);"
      ></div> */}
    </>
  );
}
