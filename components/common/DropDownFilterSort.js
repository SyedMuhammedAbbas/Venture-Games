...
export default function DropDownFilterSort({ Filter, Sort }) {
  ...
  return (
    <>
      {Filter === true && (
        <div className="grid w-60  top-[70px] bg-[#1A1A1A] opacity-95 absolute backdrop-blur-[20px] rounded-2xl p-[0rem] overflow-y-auto h-72">
          <div className="">
      ...
      {Sort === true && (
        <div className="grid w-60 top-[60px] bg-[#1A1A1A] opacity-95 absolute backdrop-blur-[20px] rounded-2xl p-[0rem] overflow-y-auto h-72">
          <div className="">
            <div className="grid items-start gap-4 justify-center py-10">
