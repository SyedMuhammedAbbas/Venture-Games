...
export default function PlatformsElement({ consoles }) {
  ...
  return (
    <div className="platformElementMainClass bg-gradient-to-tr from-[#805712] via-black to-[#805712] p-20 5xl:px-20 px-64 5xl:px-auto 4xl:px-10 2xl:px-auto mobile:p-4 min-h-[140vh] max-h-[100%] flex justify-center mobile1:items-center">
      <div className="grid gap-10 justify-center w-[125vw]  border-[1px] mobile1:h-auto  border-white rounded-[40px]  p-10 tablet2:p-5 pt-0 my-[30px]">
