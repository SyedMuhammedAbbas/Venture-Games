          ...
          <div className="grid xl2:gap-5 w-[500px] mobile:w-[80%] ">
            <div className="text-[#FFB636] text-[35px] mobile1:text-[25px] mobile1.1:text-[20px] mt-[5%] xl2:mt-[5%] loginheading1">
              ...
              <form className="border-b-[2px] xl2:w-[500px] mobile1:w-[100%] flex border-[#FFB636]">
                <input
                  className="bg-transparent text-[#FFB636] placeholder:text-[#78694f] w-[450px] outline-none mobile1:w-[100%] placeholder:opacity-90 placeholder:text-[25px] mobile1.1:placeholder:text-[15px]"
                  type="text"
                  onChange={(e) => {
