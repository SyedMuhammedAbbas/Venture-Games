          ...
          <div className="flex gap-24 xl:grid xl:grid-cols-1 mobile:grid-cols-1">
            <div className="grid xl:justify-center gap-5 pr-20 xl:pr-0 xl:pb-16 mt-6 border-r-[1px] xl:border-r-0 xl:border-b-[1px] border-white">
              <div className="mt-[40px]">
                <iframe
                  className="w-[550px] h-[400px] mobile:w-[450px] mobile:h-[300px] mobile2.1:w-[350px] mobile2.1:h-[200px] mobile1.1:w-auto rounded-[40px]"
              ...
              <div className="grid gap-3">
                ...
                <div className="mobile:w-[450px] mobile2.1:w-[350px] mobile1.1:w-auto">
                  <form className="bg-transparent border-[1px] border-white rounded-[40px]  text-white">
                    ...
                    <button className="text-white float-right pr-1 pt-[5px] text-[35px]">
                      <BiRightArrowCircle />
                    </button>
                  </form>
                </div>
            ...
            <div className="grid gap-5">
              ...
              <div>
                ...
                <div className="flex gap-5 justify-center border-[1px] border-white rounded-[40px] p-10 mobile1.1:p-auto py-5">
