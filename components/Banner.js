...
export default function Banner() {
  return (
    <div className="grid gap-20 pb-20 pl-64 snap-center mobile:pl-0 4xl:pl-[5vw] pt-20 bg-gradient-to-r from-[#000000] via-[#2d2d2d] to-[#000000] ">
      ...
      <div className="text-white text-[40px] 3xl:text-[2.5vw] mobile:text-[25px] mobile:m-3 mobile:text-center">
        ...
        ajdha fhaku We At Venture Games bahkdba hahda dhagjdhadhh bhda dgaj dada
        dahb gosj We At Venture Games bahkdba hahda dhagjdhadhh bhda dgaj
      </div>
    </div>
  );
}
