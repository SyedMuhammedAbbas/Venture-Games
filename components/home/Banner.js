...
export default function Banner() {
  ...
  return (
    <div className="grid gap-20 pb-20 relative xxl1:px-[10%] mobile:pl-0 4xl:pl-[5vw] pt-20 bg-gradient-to-r from-[#000000] via-[#2d2d2d] to-[#000000] ">
      <div className="flex mobile:grid mobile:justify-center w-[100vw] [3000px]:w-[100%] mobile:gap-10 mobile:pl-[20px] ">
        ...
        <div>
          <img
            className="w-[500px] 3xl:w-[35vw] lg:w-[40vw] mobile:w-[400px] mobilesm:w-auto rounded-full absolute xxl1:right-[15%]  mobile:relative right-10 mobile:pl-[30px] lg:right-[0px] pr-28"
            src={Controller.src}
          />
        </div>
      </div>
