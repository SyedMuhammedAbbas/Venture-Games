...
export default function Banner() {
  ...
  return (
    <div className="grid justify-center min-h-[140vh] mobile:min-h-[100vh] max-h-[100%] gap-20 pb-20 relative px-[5%] lg:px-auto pt-20 bg-gradient-to-r from-[#000000] via-[#2d2d2d] to-[#000000] ">
