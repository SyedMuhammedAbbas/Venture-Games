...
export default function Sale() {
  ...
  return (
    <div className="grid bg-gradient-to-tr from-[#33250c] via-[#1A1A1A] to-[#33250c] min-h-[100vh] max-h-[100%]  px-[40px] w-[100%] overflow-x-hidden border-b-blackOpac border-b-8 justify-center py-[10%] mobile:px-auto">
