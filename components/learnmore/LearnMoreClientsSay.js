...
export default function LearnMoreClientsSay({ heading, description }) {
  return (
    <>
      <div className="flex bg-[#1A1A1A] h-auto justify-center items-center min-h-[140vh] max-h-[100%] p-10 pt-[10vh] pb-[10vh] lg:grid lg:pt-[5vh]">
        ...
        <div className="grid mt-[10vh] xl2:mt-[0vh] lg:ml-[20vw] mobile:ml-[20vw] mobile1:ml-0">
          <p className=" text-[35px] 3xl:text-[30px] lg:text-[25px] mobile:text-[20px] text-[#FFB636]">
